...
for d in datasets:
    if d.attrib['add'] == '1':
        ...
        files = ["./SLMACROLocal", d.attrib['name'], d.attrib['title'], d.attrib['add'], d.attrib['color'], d.attrib['ls'], d.attrib['lw'], d.attrib['normf'], d.attrib['EqLumi'], d.attrib['xsection'], d.attrib['PreselEff'], d.attrib['filenames']]
        args.append(files)
outfiles = []
fileNames = []
processes = []
...
for row in args:
    ...
    f = open("Submit_Scripts/MuSubmit"+row[1]+".sh",'w')
