...
tree = ET.ElementTree(file='config/Run2SingleLepton_TOPTREES_74_El.xml')
...
processes = []
tempList = []
if not os.path.exists("Terminal_Output_El"):
    os.makedirs("Terminal_Output_El")
...
#        tempList.extend(["", ""])
        if (totalEvents > jobSize):
            ...
            while (totalEvents-(endEvent*jobSize) > 0):
                ...
                fileNames.append("Terminal_Output_El/"+tempList[1]+".out")
